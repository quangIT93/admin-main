...
const ThemePage = () => {
    ...
    useEffect(() => {
        const fetchThemes = async () => {
            ...
            if (res.success) {
                setEnabledThemes(
                    res.data.filter((theme) => theme.status === 1)
                );
                setDisabledThemes(
                    res.data.filter((theme) => theme.status === 0)
                );
            }
        };
                        ...
                        >
                            ...
                            >
                                <CardMedia
                                    ...
                                    onClick={() =>
                                        navigate(
                                            `/admin/posts?themeId=${enabledTheme.id}`
                                        )
                                    }
                                />
                                ...
                                >
                                    ...
                                    <IconButton
                                        onClick={() =>
                                            handleDisableTheme(enabledTheme)
                                        }
                                    >
                                        <DeleteIcon />
                                    </IconButton>
                        ...
                        >
                            ...
                            >
                                <CardMedia
                                    ...
                                    onClick={() =>
                                        navigate(
                                            `/admin/posts?themeId=${disabledTheme.id}`
                                        )
                                    }
                                />
                                <CardContent sx={{ padding: "1rem 0" }}>
                                ...
                                >
                                    ...
                                    <IconButton
                                        onClick={() =>
                                            handleEnableTheme(disabledTheme)
                                        }
                                    >
                                        <DeleteIcon />
                                    </IconButton>
