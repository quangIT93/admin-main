...
const SelectCategoryDialog = ({
    ...
    const [childCategoryIdSelected, setChildCategoryIdSelected] =
        useState(null);
    ...
    useEffect(() => {
        if (parentCategoryIdSelected) {
            ...
            const childs = allCategories
                .find(
                    (category) =>
                        category.parent_category_id === parentCategoryIdSelected
                )
                .childs.filter(
                    (cate) => !currentChildCategoryIds.includes(cate.id)
                );
            ...
            setCategories((prevState) => [
                ...prevState,
                {
                    ...
                    child_category: childCategories.find(
                        (childCategory) =>
                            childCategory.id === childCategoryIdSelected
                    ).name,
                ...
                >
                    ...
                    >
                        <TextField
                            ...
                            onChange={(e) =>
                                setParentCategoryIdSelected(e.target.value)
                            }
                        >
                    ...
                    >
                        <TextField
                            ...
                            label="Danh mục con"
                            value={
                                childCategoryIdSelected
                                    ? childCategoryIdSelected
                                    : ""
                            }
                            onChange={(e) =>
                                setChildCategoryIdSelected(e.target.value)
                            }
                        >
