...
const EditThemeDialog = ({
    ...
    const handleSubmitToEditTheme = async () => {
        ...
        if (addPhotoError) {
            return toast.warn(
                "Please enter valid url or upload file from device"
            );
        }
        // VALID TITLE?
                ...
                >
                    ...
                    {addPhotoTypeId === 0 && (
                        ...
                        >
                            <TextField
                                ...
                                onChange={(e) =>
                                    handleChangePhotoUrlSelected(e)
                                }
                            />
                        </FormControl>
                    )}
                        ...
                        >
                            <Button variant="outlined" component="label">
                                ...
                                <input
                                    ...
                                    accept="image/*"
                                    onChange={(e) =>
                                        handleChangePhotoUploadSelected(e)
                                    }
                                />
                            </Button>
                        </FormControl>
                    ...
                    >
                        <TextField
                            ...
                            onChange={(e) =>
                                setProvinceIdSelected(e.target.value)
                            }
                        >
                    ...
                    >
                        ...
                        {addPhotoError ? (
                            ...
                            <img
                                ...
                                // src={`${previewPhoto}`}
                                src={`${
                                    themeEdited.image || previewPhoto || ""
                                }`}
                                alt=""
                                loading="lazy"
                                onError={() => {
